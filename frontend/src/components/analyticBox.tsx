...
export default function AnalyticBox (): JSX.Element {
    ...
    return (
        <div className="w-[268px] h-[668px] flex flex-col box-border gap-[16px]">
            ...
            <button className='flex gap-[6px] justify-center items-center h-[48px] w-[268px] rounded-[19px] content-center pt-[6px] pb-[6px] pl-[12px] pr-[21px] bg-[#0D062D] text-white' >
